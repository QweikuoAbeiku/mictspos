					...
					<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
						<table class="sales_table_100">
							...
							<tr>
								...
								<td>
									<?php echo form_input(array('name'=>'amount_tendered', 'id'=>'amount_tendered', 'class'=>'form-control input-sm disabled', 'disabled'=>'disabled', 'value'=>to_currency_no_money($amount_due), 'size'=>'5', 'tabindex'=>++$tabindex, 'onClick'=>'this.select();')); ?>
								</td>
							</tr>
				...
				?>
					<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
						<table class="sales_table_100">
							...
							<tr>
								<td>
								<span id="user_phone_label">Customer Phone:</span>
								</td>
								<td>
									<?php echo form_input(array('name'=>'customerPhone', 'id'=>'customerPhone', 'class'=>'form-control input-sm')); ?>
								</td>
							</tr>
						</table>
					<?php echo form_close(); ?>
...
function check_payment_type()
{
	...
	else if(($("#payment_types").val() == "<?php echo $this->lang->line('sales_cash'); ?>" && cash_mode == '1'))
	{
		...
		$("#user_phone_label").html("<?php echo $this->lang->line('sales_amount_tendered'); ?>");
