...
class Sms_lib
{
	...
	public function sendRecieptSMS($phone){
		$msg = "Thanks for purchasing, please shop here soon";
		$url = "https://apps.mnotify.net/smsapi?key=BP5BykdkH83M4v2ZD7HnRchRV&to=$phone&msg=$msg&sender_id=MICTS";
		$fp = fopen($url, 'r');
		$response = fread($fp, 1024);
